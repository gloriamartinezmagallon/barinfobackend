...
class gPoint
{
    ...
    public function UTMLetterDesignator()
    {
        if ((84 >= $this->lat) && ($this->lat >= 72)) {
            $LetterDesignator = 'X';
        } else if ((72 > $this->lat) && ($this->lat >= 64)) {
            $LetterDesignator = 'W';
        } else if ((64 > $this->lat) && ($this->lat >= 56)) {
            $LetterDesignator = 'V';
        } else if ((56 > $this->lat) && ($this->lat >= 48)) {
            $LetterDesignator = 'U';
        } else if ((48 > $this->lat) && ($this->lat >= 40)) {
            $LetterDesignator = 'T';
        } else if ((40 > $this->lat) && ($this->lat >= 32)) {
            $LetterDesignator = 'S';
        } else if ((32 > $this->lat) && ($this->lat >= 24)) {
            $LetterDesignator = 'R';
        } else if ((24 > $this->lat) && ($this->lat >= 16)) {
            $LetterDesignator = 'Q';
        } else if ((16 > $this->lat) && ($this->lat >= 8)) {
            $LetterDesignator = 'P';
        } else if ((8 > $this->lat) && ($this->lat >= 0)) {
            $LetterDesignator = 'N';
        } else if ((0 > $this->lat) && ($this->lat >= -8)) {
            $LetterDesignator = 'M';
        } else if ((-8 > $this->lat) && ($this->lat >= -16)) {
            $LetterDesignator = 'L';
        } else if ((-16 > $this->lat) && ($this->lat >= -24)) {
            $LetterDesignator = 'K';
        } else if ((-24 > $this->lat) && ($this->lat >= -32)) {
            $LetterDesignator = 'J';
        } else if ((-32 > $this->lat) && ($this->lat >= -40)) {
            $LetterDesignator = 'H';
        } else if ((-40 > $this->lat) && ($this->lat >= -48)) {
            $LetterDesignator = 'G';
        } else if ((-48 > $this->lat) && ($this->lat >= -56)) {
            $LetterDesignator = 'F';
        } else if ((-56 > $this->lat) && ($this->lat >= -64)) {
            $LetterDesignator = 'E';
        } else if ((-64 > $this->lat) && ($this->lat >= -72)) {
            $LetterDesignator = 'D';
        } else if ((-72 > $this->lat) && ($this->lat >= -80)) {
            $LetterDesignator = 'C';
        } else {
            $LetterDesignator = 'Z';
        }
